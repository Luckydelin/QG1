...
public:
	...
	enum class ShowMode { Test1, Test2,Test3 };
...
private:
	...
	ComPtr<ID3D11ShaderResourceView> m_pTextureInputA;			    // 木盒纹理
	ComPtr<ID3D11ShaderResourceView> m_pTextureOne;
	ComPtr<ID3D11ShaderResourceView> m_pTextureTwo;
	ComPtr<ID3D11ShaderResourceView> m_pTextureThree;
	ComPtr<ID3D11ShaderResourceView> m_pTextureFour;
	ComPtr<ID3D11ShaderResourceView> m_pTextureFive;
	ComPtr<ID3D11ShaderResourceView> m_pTextureSix;
	...
	VSConstantBuffer m_VSConstantBuffer3;						// 用于修改用于VS的GPU常量缓冲区的变量
	VSConstantBuffer m_VSConstantBuffer1;						// 用于修改用于VS的GPU常量缓冲区的变量
